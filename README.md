...
## 📂  Inicialização conatiner  do Nest

Para iniciar o container do projeto Nest, execute o seguinte comando:
...
npx prisma studio
```
## 🛠️ Visualizar dataBase
Para visualizar a tabela, acesse o link:
```bash
 http://localhost:5555
```
